...
// import "./SimilarMenProducts.css";
import { FaAngleLeft } from "react-icons/fa6";
import { FaAngleRight } from "react-icons/fa6";
import { Link } from "react-router-dom";

const SimilarMenProducts = () => {
  ...
  return (
    <div>
      ...
      {currentIndex != 0 && (
        <button
          className="toprated_btn toprated_prev_btn"
      ...
      <button className="toprated_btn toprated_next_btn" onClick={nextSlide}>
        <FaAngleRight
          style={{
            filter: "drop-shadow(0 2px 3px rgba(0, 0, 0, 0.8))",
            color: "white",
...
export default SimilarMenProducts;
